...
Relay this to the user briefly, in their working language. If the guide is empty or the language is unset, suggest running the `init` command first. Do not invent rules that are not shown above.
