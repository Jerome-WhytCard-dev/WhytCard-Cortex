...
Confirm, in the user's working language, what was removed (or that nothing matched). If they meant a different rule, suggest running the `show` command to see the numbered list, then `forget <number>`.
